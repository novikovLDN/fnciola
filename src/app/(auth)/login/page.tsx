...
/** Вход (§11.2): email + пароль ИЛИ passkey (WebAuthn). Демо: вход открывает кабинет. */
export default function LoginPage() {
  ...
  return (
    <div className="card ring-gradient">
      ...
      <button onClick={passkeyLogin} className="btn btn-primary mt-6 w-full"><IconKey size={18} /> Войти по passkey</button>
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <button className="btn btn-secondary w-full">Войти</button>
      </form>
